...
const Index = () => {
  ...
  const handleSendToAudit = async () => {
    ...
    try {
      const response = await sendToWebhook(extractedText, fileName);
...
${result.type.toUpperCase()}: ${result.category}
            ...
            {extractedText && !isAnalyzing && (
              <Card className="p-4 bg-gradient-to-br from-card to-accent border border-primary/20">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="font-medium text-card-foreground">Extracted Content Preview</h3>
                  <Button 
                ...
                <div className="max-h-32 overflow-y-auto text-sm text-muted-foreground bg-muted/50 p-3 rounded">
